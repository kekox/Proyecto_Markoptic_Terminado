...
/*$(window).load(function() {
  ...
  <section >
              ...
              <div class="row">
                ...
                <div id="formproyectos" >
                  	<div class="col-lg-10 col-lg-offset-1">
                  		...
                  		<center><h3><a href="../dashboard" onclick="window.history.back();"class="fa fa-arrow-left color-black " style="text-decoration:none;">&nbsp;&nbsp;&nbsp;</a>Proyecto - Sección 1/10</h3></center>
                  		<br>
                  		<br>
						<center><span id="_mensaje" class="display-errors" ></span></center>
				            ...
				            <div id="formularioproyecto" class="space">
								...
								<input class="btn btn-primary btn-block roboto" id="btnproyecto" type="button" value="Guardar">
	...
	<!-- Messages-->
 	...
 	@include('includes.Messages.MessageFolioExistente')
          ...
          data: $('#formproyectos1').serialize(), //Se obtienen los datos del formulario
            ...
            error: function (XMLHttpRequest, textStatus, errorThrown) {
            	if (XMLHttpRequest.status === 500) {
            		$('.MessageFolioExistente').modal('show');	
