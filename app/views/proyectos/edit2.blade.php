              ...
              <div class="row">
                ...
                <div id="formproyectos" >
                  	<div class="col-lg-10 col-lg-offset-1">
                  		...
                  		<center><h3><a class="fa fa-arrow-left color-black " style="text-decoration:none;" onclick="window.history.back();">&nbsp;&nbsp;&nbsp;</a>Proyecto - Sección 1/10</h3></center>
                  		<br>
                  		<br>
				            ...
				            <div id="formularioproyecto" class="space">
		                		...
		                		<div class="col-lg-12"> <!-- Empieza el cero campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo0" placeholder="Informacion acerca del campo..."name="campo0" row="2">{{$proyecto->nombre_proyecto}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
		               			...
		               			<div class="col-lg-12"> <!-- Empieza el primer campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo1" placeholder="Informacion acerca del campo..."name="campo1" row="2" readonly>{{$proyecto->folio}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el segundo campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo2" placeholder="Informacion acerca del campo..." name="campo2" row="2">{{$proyecto->modalidad}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el tercer campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo3" placeholder="Informacion acerca del campo..."name="campo3" row="2">{{$proyecto->tipo_de_proyecto}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el cuarto campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo4" placeholder="Informacion acerca del campo..."name="campo4" row="2">{{$proyecto->contextualizacion}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el quinto campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo5" placeholder="Informacion acerca del campo..."name="campo5" row="2">{{$proyecto->propuesta}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el sexto campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo6" placeholder="Informacion acerca del campo..."name="campo6" row="2">{{$proyecto->area_industrial}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el septimo campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo7" placeholder="Informacion acerca del campo..."name="campo7" row="2">{{$proyecto->area_conocimiento}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el octavo campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo8" placeholder="Informacion acerca del campo..."name="campo8" row="2">{{$proyecto->palabras_clave}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el noveno campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo9" placeholder="Informacion acerca del campo..."name="campo9" row="2">{{$proyecto->descripcion_innovacion}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el decimo campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo10" placeholder="Informacion acerca del campo..."name="campo10" row="2">{{$proyecto->tipo_innovacion}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el onceavo campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo11" placeholder="Informacion acerca del campo..."name="campo11" row="2">{{$proyecto->grado_innovacion}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el doceavo campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo12" placeholder="Informacion acerca del campo..."name="campo12" row="2">{{$proyecto->tipo_mercado}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<input class="btn btn-primary btn-block roboto" id="btnproyectoedit" type="button" value="Guardar">
...
$(document).ready(function(){
    ...
    $('#btnproyectoedit').on('click',function()
    {
    	var id = $('campo01').val();
    	console.log(id);
    	$.ajax({
          ...
          data: $('#formproyectos1').serialize(), //Se obtienen los datos del formulario
            ...
            success: function(datos)
            {
              ...
              $('#_campo0 ,#_campo2 ,#_campo3 ,#_campo4 ,#_campo5 ,#_campo6 ,#_campo7 ,#_campo8 ,#_campo9 ,#_campo10 ,#_campo11 ,#_campo12').text('');
                ...
                $.each(datos.errors, function(index, value)
                {
                  ...
                  setTimeout(function(){window.location.href='../../../../dashboard/'+datos.dada} , 1500);  
