              ...
              <div class="row">
                ...
                <div id="formproyectos" >
                  	<div class="col-lg-10 col-lg-offset-1">
                  		...
                  		<center><h3><a class="fa fa-arrow-left color-black " style="text-decoration:none;" onclick="window.history.back();">&nbsp;&nbsp;&nbsp;</a>Asesoría - Sección 10/10</h3></center>
				            ...
				            <div id="formularioasesoria" class="space">
		                		...
		                		<div class="col-lg-12"> <!-- Empieza el cero campo -->
		               			...
		               			<div class="col-lg-12"> <!-- Empieza el primer campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo1" placeholder="Informacion acerca del campo..."name="campo1" row="2">{{$proyecto->pregunta_1}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el segundo campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo2" placeholder="Informacion acerca del campo..." name="campo2" row="2">{{$proyecto->pregunta_2}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el tercer campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo3" placeholder="Informacion acerca del campo..."name="campo3" row="2">{{$proyecto->pregunta_3}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el cuarto campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo4" placeholder="Informacion acerca del campo..."name="campo4" row="2">{{$proyecto->pregunta_4}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el quinto campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo5" placeholder="Informacion acerca del campo..."name="campo5" row="2">{{$proyecto->responsable_del_proyecto}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<input class="btn btn-primary btn-block roboto" id="btnasesoria" type="button" value="Guardar">
