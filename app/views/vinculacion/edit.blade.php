				            ...
				            <div id="formulariovinculacion" class="space">
		                		...
		                		<div class="col-lg-12"> <!-- Empieza el cero campo -->
		               			...
		               			<div class="col-lg-12"> <!-- Empieza el primer campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo1" placeholder="Información acerca del campo..."name="campo1" row="2">{{$proyecto->razones}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el segundo campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo2" placeholder="Información acerca del campo..." name="campo2" row="2">{{$proyecto->sinergias_marketing}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el tercer campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo3" placeholder="Información acerca del campo..."name="campo3" row="2">{{$proyecto->sinergias_tecnologias}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
								...
								<div class="col-lg-12"> <!-- Empiezan el cuarto campo -->
			               			<section  class="form-group">
				               			...
				               			<div class="col-lg-7">
				               				<textarea type="text" class="form-control"  id="campo4" placeholder="Información acerca del campo..."name="campo4" row="2">{{$proyecto->sinergias_produccion}}</textarea> 
				               			</div>
				               			<div class="col-lg-1">
