...
class GeneralController extends Controller {
	...
	public function create(){	
		...
		return View::make('general/create',array('perfiles' => $perfiles));
	}
	...
	public function edit($folio_proyecto){
		...
		return View::make('general/edit',array('perfiles' => $perfiles,'proyectos'=>$proyectos)); 
	}
		...
		if($validator->passes()){
			if(Request::ajax()){
				DB::table('generales')
			            ...
			            ->update(array(
							'nivel_de_tecnologia'             => Input::get('campo1'),
							'nivel_de_innovacion'             => Input::get('campo2'),
							'riesgo_tecnico'                  => Input::get('campo3'),
							'principal_resultado'             => Input::get('campo4'),
							'presupuesto_de_proyecto'         => Input::get('campo5'),
							'administracion_del_proyecto'     => Input::get('campo6'),
							'disponibilidad_y_compatibilidad' => Input::get('campo7'),
							'plan_de_proteccion'              => Input::get('campo8'),
							'generacion_de_ingresos'          => Input::get('campo9')
							));
