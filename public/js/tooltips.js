    ...
    $('#formulariodescripciones').on('mouseover',function()
     {
            $("#myTooltip0").tooltip({
                html:true,
                title : 'Indique el folio del proyecto. El cual señalo al principio. <br><br> (En caso de no recordar el folio puede regresar y ver el número de folio del proyecto).',
                placement : 'right',
                trigger: 'click hover',
                container: 'body'
